...
class TrainingEntry extends Component {
    constructor(props) {
        super(props);
        this.state = {
            branchList: [],
                            ...
                            <div className="form-search form-group">
                                <div className="col-md-12">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-3">
                                            <div className="input-group svX2">
                                                <label className="input-group-addon imagetype-width" id="lastName-addon">Place </label>
                                                <input className="form-control" type="number" id="salary" name="salary" onChange={this.handleChange.bind(this)} />
                                    ...
                                    <div className="col-md-13">
                                        <div className="input-group svX3">
                                            <label className="input-group-addon imagetype-width" id="lastName-addon">Training Name</label>
                                            <input className="form-control" type="number" id="salary" name="salary" onChange={this.handleChange.bind(this)} />
                                        </div>
                                    </div>
                                    <div className="col-md-13">
                                        <div className="input-group svX3">
                                            <label className="input-group-addon imagetype-width" id="lastName-addon">Organizer</label>
